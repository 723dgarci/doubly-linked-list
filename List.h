...
namespace cop4530 {
    ...
    public:
        ...
        //recureively count the elements
        int count(int s = 0, iterator i = iterator{}); //default arguments used for counting and because you have to give a static default value
